                                    ...
                                    <div className="space-y-12">
                                        <div>
                                            ...
                                            <div className="space-y-6">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    <div className="w-10 h-10 rounded-xl bg-gray-50 dark:bg-gray-700 flex items-center justify-center text-accent">
                                                        <Briefcase size={20} />
                                                    </div>
                                                    <div>
                                                ...
                                                <div className="flex items-center gap-4">
                                                    <div className="w-10 h-10 rounded-xl bg-gray-50 dark:bg-gray-700 flex items-center justify-center text-warning">
                                                        <LinkIcon size={20} />
                                                    </div>
                                                    <div>
